...
class LoginRepository{
     ...
     static func loginUser(db: OpaquePointer?, username: String, enteredPassword: String) -> Bool {
            ...
            let cStringPassword = enteredPassword.cString(using: .utf8)
            ...
            print(cStringUsername)
            print(cStringPassword)
            print(hashedPasswordFromDB)
            print(hashPassword(enteredPassword, salt: saltFromDB)!)
            print(saltFromDB)
